...
const Images = (folder: string, count: number) =>
	Array.from({ length: count }, (_, i) => `${import.meta.env.BASE_URL}assets/${folder}Images/${i}.webp`)
...
function App() {
	...
	const projectImages = [
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/0.webp`, url: '/projects/mintube' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/1.webp`, url: '/projects/portableai' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/2.webp`, url: '/projects/simengine' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/3.webp`, url: '/projects/mlpassivepredictor' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/4.webp`, url: '/projects/dokkandata' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/5.webp`, url: '/projects/discaitts' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/6.webp`, url: '/projects/dokkanguessr' },
		{ src: `${import.meta.env.BASE_URL}assets/projectImages/7.webp`, url: '/projects/santaobby' },
	]
